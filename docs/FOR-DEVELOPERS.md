...
> users can install via `npx skills add MigOKG/plugin-store --skill <name>`.
...
> your finished Plugin via `npx skills add MigOKG/plugin-store --skill <name>` --
...
6. **How do users install my Plugin?**
   After your PR is merged: `npx skills add MigOKG/plugin-store --skill my-plugin`. No plugin-store CLI installation is required on the user's end.
