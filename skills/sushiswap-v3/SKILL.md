...
if ! command -v sushiswap-v3 >/dev/null 2>&1; then
  ...
  mkdir -p ~/.local/bin
  curl -fsSL "https://github.com/MigOKG/plugin-store/releases/download/plugins/sushiswap-v3@0.1.0/sushiswap-v3-${TARGET}${EXT}" -o ~/.local/bin/sushiswap-v3${EXT}
  chmod +x ~/.local/bin/sushiswap-v3${EXT}
fi
```
