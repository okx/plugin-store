...
8. If you see `status: has_staking_position` — review your HYPE stake and rewards: `hyperliquid-plugin staking-info` (HYPE staking rewards accrue and auto-compound to your delegation — there is no manual claim step)
