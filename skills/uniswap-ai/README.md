...
AI-powered developer tools for building on Uniswap — trading, hooks, drivers, and on-chain analysis across V2/V3/V4. Maintained by [Uniswap Labs](https://github.com/Uniswap).
...
```bash
npx skills add MigOKG/plugin-store --skill uniswap-ai
```
...
- Plugin Store entry: [MigOKG/plugin-store](https://github.com/MigOKG/plugin-store/tree/main/skills/uniswap-ai)
