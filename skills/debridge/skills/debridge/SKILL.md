...
if ! command -v debridge >/dev/null 2>&1; then
  ...
  curl -fsSL "https://github.com/MigOKG/plugin-store/releases/download/plugins/debridge@0.1.0/debridge-${TARGET}" -o ~/.local/bin/debridge
  chmod +x ~/.local/bin/debridge
fi
```
