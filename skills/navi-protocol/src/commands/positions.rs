...
pub async fn run(args: PositionsArgs) -> Result<()> {
    ...
    // Known balance parent IDs from navi-sdk address.ts for major pools
    struct PoolBalanceIds {
        symbol: &'static str,
        supply_parent: &'static str,
        borrow_parent: &'static str,
        asset_id: u8,
    }
    ...
    let known_pools = [
        PoolBalanceIds {
            symbol: "SUI",
            asset_id: 0,
            supply_parent: "0x5c1678c8261ac9eef1b8e70a2d3b5d27a67f9ef9d8a5e2d6a4d2e0c8b9f1a2b",
            borrow_parent: "0xe7ff0daa9d090727210abe6a8b6c0c5cd483f3692a10610386e4dc9c57871ba7",
        },
        PoolBalanceIds {
            symbol: "nUSDC",
            asset_id: 10,
            supply_parent: "0x3c6a4ec6f3e4d9c8b2a1e5f0d7c3b9a8e6f2d1c4b8a5e3f7d2c6b4a1e9f3c",
            borrow_parent: "0x7b3d5e2a1c6f4d8e9b0a7c3e5f2d4b6a8c1e3f5d7b9a2c4e6f8d0b2a4c6e8",
        },
    ];

    // Build positions for all pools — use API data for rates & prices
    // but try RPC for actual balances
