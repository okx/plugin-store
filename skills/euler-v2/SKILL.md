...
if ! command -v euler-v2 >/dev/null 2>&1; then
  ...
  mkdir -p ~/.local/bin
  curl -fsSL "https://github.com/MigOKG/plugin-store/releases/download/plugins/euler-v2@0.1.0/euler-v2-${TARGET}${EXT}" -o ~/.local/bin/euler-v2${EXT}
  chmod +x ~/.local/bin/euler-v2${EXT}
fi
```
