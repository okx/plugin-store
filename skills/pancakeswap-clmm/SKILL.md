...
if ! command -v pancakeswap-clmm >/dev/null 2>&1; then
  ...
  mkdir -p ~/.local/bin
  curl -fsSL "https://github.com/MigOKG/plugin-store/releases/download/plugins/pancakeswap-clmm@0.1.0/pancakeswap-clmm-${TARGET}${EXT}" -o ~/.local/bin/pancakeswap-clmm${EXT}
