...
/// TokenManager V1 — legacy, for tokens created before Sept 5, 2024
...
/// 1 BNB in wei (10^18)
pub const ONE_BNB_WEI: u128 = 1_000_000_000_000_000_000;

/// 1 GWEI in wei — amounts must be aligned to gwei
