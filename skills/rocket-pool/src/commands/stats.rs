...
pub async fn run(args: StatsArgs) -> anyhow::Result<()> {
    ...
    let total_eth_wei = {
        ...
        let result = onchainos::eth_call(chain_id, &contracts.network_balances, &calldata).await?;
    ...
    let total_reth_wei = {
        ...
        let result = onchainos::eth_call(chain_id, &contracts.token_reth, &calldata).await?;
        let data = rpc::extract_return_data(&result)?;
        rpc::decode_uint256(&data).unwrap_or(0)
    };
    ...
    let node_count = {
        ...
        let result = onchainos::eth_call(chain_id, &contracts.node_manager, &calldata).await?;
        let data = rpc::extract_return_data(&result)?;
        rpc::decode_uint256(&data).unwrap_or(0)
    };
    ...
    let minipool_count = {
        ...
        let result = onchainos::eth_call(chain_id, &contracts.minipool_manager, &calldata).await?;
        let data = rpc::extract_return_data(&result)?;
        rpc::decode_uint256(&data).unwrap_or(0)
    };
    ...
    let deposit_pool_eth_wei = {
        ...
        let result = onchainos::eth_call(chain_id, &contracts.deposit_pool, &calldata).await?;
        let data = rpc::extract_return_data(&result)?;
        rpc::decode_uint256(&data).unwrap_or(0)
    };
