...
/// Fetch the active wallet address for the given chain.
...
/// `--force` is always appended — required for all DEX write operations.
/// In dry_run mode, returns a synthetic response immediately without calling onchainos.
