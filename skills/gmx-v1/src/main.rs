...
async fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        Commands::Swap {
            ...
            commands::swap::run(chain, &input_token, input_amount, &output_token, min_output, dry_run, confirm).await?;
        }
        ...
        Commands::BuyGlp {
            ...
            commands::buy_glp::run(chain, &token, amount, min_usdg, min_glp, dry_run, confirm).await?;
        }
        ...
        Commands::SellGlp {
            ...
            commands::sell_glp::run(chain, &token_out, glp_amount, min_out, dry_run, confirm).await?;
        }
        ...
        Commands::ApproveToken {
            ...
            commands::approve_token::run(chain, &token, &spender, dry_run, confirm).await?;
        }
    }
