...
/// Submit an EVM transaction via onchainos wallet contract-call
/// confirm=true: passes --force to broadcast; confirm=false: preview only
...
pub async fn erc20_approve(
    ...
    wallet_contract_call_force(chain_id, token_addr, &calldata, from, None, dry_run, confirm).await
}
